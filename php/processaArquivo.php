...
if (file_put_contents($caminhoArquivo, $textoDoArquivo) != false) {
    $_SESSION['msg'] .= "<br><p class='p-green'>Arquivo " . $nomeArquivoComExtensao . " finalizado com sucesso! <span class='p-blue'>" . $contSubstituidas . " expressões</span> foram substituídas automaticamente.</p>";
} else {
